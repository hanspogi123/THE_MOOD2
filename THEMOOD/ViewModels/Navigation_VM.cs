...
namespace THEMOOD.ViewModels
{
    public partial class NavBarViewModel : ObservableObject
    {
        ...
        private NavBarViewModel()
        {
            ...
            _viewCache["Voice"] = new Lazy<Microsoft.Maui.Controls.View>(() => 
            {
                var audioManager = Application.Current.Handler.MauiContext.Services.GetService<IAudioManager>();
                var openAIService = Application.Current.Handler.MauiContext.Services.GetService<OpenAIService>();
                return new THEMOOD.Pages.Voice(audioManager, openAIService);
            });
            _viewCache["Game"] = new Lazy<Microsoft.Maui.Controls.View>(() => new THEMOOD.Pages.Game());
        }
        ...
        public void ClearViewCache()
        {
            ...
            if (!_viewCache.ContainsKey("Game"))
                _viewCache["Game"] = new Lazy<Microsoft.Maui.Controls.View>(() => new THEMOOD.Pages.Game());
